...
\begin{document}
	...
	\begin{table}[h]
		...
		\begin{tabular}{ |p{2cm}|p{2cm}|p{2cm}|p{2cm}|  }
			...
			\hline
		\end{tabular}
		\captionof{table}{\centering Temps d'exécution d'un produit matrice vecteur selon la version, le temps est mesuré 60 fois et une moyenne est prise. Le produit est fait sur une matrice symétrique de dimension 20000 et le temps est en secondes.}
	\end{table}
